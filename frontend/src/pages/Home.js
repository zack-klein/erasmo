...
export default function Home() {
  const [portfolios, setPortfolios] = useState(
    <Label content="Fetching portfolios..." />
  );
      ...
      <Container text>
        <Grid>
          <Grid.Row style={{ marginTop: "2em" }} columns={1}>
            <Grid.Column>
              <div align="center">
                <Header size="huge">Erasmo</Header>
              </div>
            </Grid.Column>
          </Grid.Row>
          ...
          <Grid.Row columns={1}>
            <Grid.Column>
              <div align="center">
                ...
                <p>Erasmo is a tool to build fake stock portfolios.</p>

                <p>
                  You can create a new portfolio, or you can view/modify an
                  existing one.
                </p>
              </div>
            </Grid.Column>
          ...
          <Grid.Row columns={2}>
            <Grid.Column>
              <Form
                ...
                error={error}
              >
                <Header size="large">New Portfolio</Header>
                <Form.Input
            ...
            <Grid.Column>
              <Header size="large">Existing Portfolios</Header>
              {portfolios}
            </Grid.Column>
          </Grid.Row>
        </Grid>
